...
export const getProducts = (branchId) =>
  wrap(api.get('/products/', { params: { branch: branchId } }))
...
export const getProductStats = (branchId) =>
  api.get(`/products/stats/?branch=${branchId}`)
export const getAlerts = (branchId, sendEmail = false) =>
  api.get(
    '/products/alerts/?branch=' + branchId + (sendEmail ? '&send_email=true' : '')
  )

export const getCustomers = (branchId) =>
  wrap(api.get('/customers/', { params: { branch: branchId } }))
...
export const getOrders = (branchId) =>
  wrap(api.get('/orders/', { params: { branch: branchId } }))
export const getOrder = (id) => api.get(`/orders/${id}/`)
export const createOrder = (data) => api.post('/orders/', data)
export const updateOrder = (id, data) => api.put(`/orders/${id}/`, data)
export const deleteOrder = (id) => api.delete(`/orders/${id}/`)
export const createOrderItem = (data) => api.post('/order-items/', data)
export const getNextOrderNumber = (branchId) =>
  api.get('/orders/next_number/?branch=' + branchId)
export const addPayment = (orderId, data) =>
  api.post('/orders/' + orderId + '/add_payment/', data)
export const writeOffOrder = (orderId, notes) =>
  api.post('/orders/' + orderId + '/writeoff/', { notes })

export const getSuppliers = () => wrap(api.get('/suppliers/'))
export const getSupplier = (id) => api.get(`/suppliers/${id}/`)
export const createSupplier = (data) => api.post('/suppliers/', data)
export const updateSupplier = (id, data) => api.put(`/suppliers/${id}/`, data)
export const getPurchases = (branchId) =>
  wrap(api.get('/purchases/', { params: { branch: branchId } }))
...
export const recordPayment = (purchaseId, amount) =>
  api.post(`/purchases/${purchaseId}/record_payment/`, { amount })

export const getPLReport = (branchId, period = 'month') =>
  api.get(`/revenue/pl_report/?branch=${branchId}&period=${period}`)
export const getExpenses = (branchId) =>
  wrap(api.get(`/expenses/?branch=${branchId}`))
...
export const getReports = (branchId) =>
  wrap(api.get('/reports/', { params: { branch: branchId } }))
